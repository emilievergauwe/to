        ...
        <div class="loginMainDiv">
            <div>
                ...
                <div class="bg-white rounded-lg shadow-lg py-4 px-5">
                    <div class="secondaryTitle mb-3">Register</div>
                    <form method="POST" action="{{ route('register') }}">
                        @csrf
                        <div class="pb-1">
                            <div style="font-size: 12px; font: normal normal 600 13px/30px Poppins;">Your e-mail</div>
                            <input type="email" id="email" class="border p-1 mb-4" style="width : 100%" type="email">
                        </div>
                        <div class="pb-1" >
                            <div style="font-size: 12px; font: normal normal 600 13px/30px Poppins;">Password</div>
                            <input type="password" id="password" class="border p-1 mb-4" style="width : 100%" type="password">
                        </div>
                        <div class="pb-1">
                            <div style="font-size: 12px; font: normal normal 600 13px/30px Poppins;">Password Confirm</div>
                            <input type="password" id="password-confirm" class="border p-1 mb-4" style="width : 100%" type="password">
                        </div>
